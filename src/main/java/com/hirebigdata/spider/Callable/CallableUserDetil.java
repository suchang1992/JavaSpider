...
import com.hirebigdata.spider.pojo.ZhihuUserDetil;
 ...
 */
public class CallableUserDetil implements Callable {
    ZhihuUserDetil zhihuUserDetil = new ZhihuUserDetil();
    public CallableUserDetil(ZhihuUser user) {
    ...
    public ZhihuUserDetil call() throws Exception {
        ...
        return zhihuUserDetil;
    }

    private int getUserDetil(ZhihuUserDetil zhihuUserDetil) throws IOException {
