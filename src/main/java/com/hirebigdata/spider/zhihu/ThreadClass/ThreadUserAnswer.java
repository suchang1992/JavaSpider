...
import com.hirebigdata.spider.zhihu.pojo.Answer;
 ...
 */
public class ThreadUserAnswer implements Runnable {
    ZhihuUserAnswer zhihuUserAnswer;
    int pageNum = 1;
    String Url_name;
    String User_data_id;

    public ThreadUserAnswer(String user_data_id, String url_name, int pageNum, ZhihuUserAnswer zhihuUserAnswer) {
        User_data_id = user_data_id;
        Url_name = url_name;
        this.pageNum = pageNum;
        this.zhihuUserAnswer = zhihuUserAnswer;
    }
