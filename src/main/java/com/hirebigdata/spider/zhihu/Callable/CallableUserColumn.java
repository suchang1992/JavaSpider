...
import com.hirebigdata.spider.zhihu.pojo.Column;
import com.hirebigdata.spider.zhihu.pojo.ZhihuUserColumn;
 ...
 */
public class CallableUserColumn implements Callable{
    ZhihuUserColumn zhihuUserColumn = new ZhihuUserColumn();
    String User_data_id;
    String User_Url_name;

    public CallableUserColumn(String user_data_id, String user_Url_name) {
        User_data_id = user_data_id;
        User_Url_name = user_Url_name;
    }
    @Override
    public ZhihuUserColumn call() throws Exception {
