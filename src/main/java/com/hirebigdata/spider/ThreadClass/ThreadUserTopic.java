...
import com.hirebigdata.spider.pojo.Topic;
import com.hirebigdata.spider.pojo.ZhihuUserTopic;
 ...
 */
public class ThreadUserTopic implements Runnable {
    ZhihuUserTopic zhihuUserTopic = new ZhihuUserTopic();
    String User_data_id;
    String User_Url_name;

    public ThreadUserTopic(String user_data_id, String user_Url_name) {
